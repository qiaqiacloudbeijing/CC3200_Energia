...
const char* HttpClient::kUserAgent = "Basic emhhbmdxaWhhb21haWxAMTI2LmNvbTphdnY4YTQ3N213dnJreXZl";
...
int HttpClient::sendInitialHeaders(const char* aServerName, IPAddress aServerIP, uint16_t aPort, const char* aURLPath, const char* aHttpMethod, const char* aUserAgent)
{
    ...
    if (aUserAgent)
    {
		...
		//sendHeader("Authorization", "Basic emhhbmdxaWhhb21haWxAMTI2LmNvbTphdnY4YTQ");   //zhangdanfeng
    }
    else
    {
